...
class ThirdWidget(QWidget):
    ...
    def __init__(self):
        ...
        self.label1 = QLabel("Количеcтво АТС в указанном районе открытых за указанный период:")
        font = QFont()
        ...
        self.gridlayout.addWidget(self.date2, 1, 3)
        self.gridlayout.addWidget(self.btn, 1, 6)
        self.gridlayout.addWidget(self.box, 1, 4)
    ...
    def update(self):
        ...
        s = ("select atc.id_atc, atc.caption, district.name_district, atc.address, atc.year, "
                              ...
                              " from atc join district on atc.id_district = district.id "
                              "where atc.year < '" + date2 +
                              "' and atc.year > '" + date1 + "'" +
                            " and district.name_district = '" + district + "'")
